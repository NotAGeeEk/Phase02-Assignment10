            ...
            <table class="w-100">
                <tr>
                    <td class="auto-style2">
                        <asp:Image ID="Image2" runat="server" Height="172px" ImageUrl="~/Camera.jpeg" Width="302px" />
                    </td>
                    <td class="auto-style3">
                        <asp:Image ID="Image1" runat="server" Height="196px" ImageUrl="~/camera1.jpeg" Width="261px" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sony Cameraa</td>
                    <td class="auto-style3">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Canon Camera</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style11">
                        <asp:DropDownList ID="DdlCategory" runat="server" Height="45px" Width="125px">
                            ...
                            <asp:ListItem>Sony Camera</asp:ListItem>
                            <asp:ListItem>Canon Camera</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    <td class="auto-style6">Priceee</td>
